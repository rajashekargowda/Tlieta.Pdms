...
namespace Tlieta.Pdms.DB
{
    public static class Encryption
    {
        ...
        public static string Encrypt(string clearText, string Password)
        {
            ...
            return Convert.ToBase64String(encryptedData).Substring(0,20);
        }
        ...
        public static string CreateRandomPassword(int passwordLength)
        {
            ...
            chars[6] = allowedNumbers[rd.Next(0, allowedNumbers.Length)];
            chars[7] = allowedNumbers[rd.Next(0, allowedNumbers.Length)];
            //chars[7] = allowedSpecialChars[rd.Next(0, allowedNumbers.Length)];
            return new string(chars);
        }
    }
}
